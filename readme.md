...
- [Important, commonly-used datasets in high quality, easy-to-use & open form as data packages](https://github.com/datasets/)

## Misc
- [Enron Email Dataset](http://www.cs.cmu.edu/~enron/)
- [Google Books Ngrams](https://aws.amazon.com/datasets/google-books-ngrams/)
- [Million Song Dataset](https://labrosa.ee.columbia.edu/millionsong/)
- [London Stock Exchange Group - TRADE REPOSITORY PUBLIC DATA](https://www.lseg.com/markets-products-and-services/post-trade-services/unavista/unavista-solutions/emir-trade-repository/trade-repository-public-data)
- [cooldatasets.com](https://www.cooldatasets.com/)
- [English-language Wikipedia](https://en.wikipedia.org/wiki/Wikipedia:Database_download#English-language_Wikipedia)
...
- [census.gov](https://www2.census.gov/)
